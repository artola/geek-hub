/**
 * @generated SignedSource<<501e2e92978dd2e64de3cb728a6ec924>>
...
return {
  ...
  "params": {
    "cacheID": "080d0c694bb3775eb548a2802163ec9e",
    "id": null,
    "metadata": {},
    "name": "followingPaginationQuery",
    "operationKind": "query",
    "text": "query followingPaginationQuery(\n  $count: Int = 5\n  $cursor: String\n  $id: ID!\n) {\n  node(id: $id) {\n    __typename\n    ...followingFragment_1G22uz\n    id\n  }\n}\n\nfragment followedFragment on User {\n  login\n}\n\nfragment followingFragment_1G22uz on User {\n  following(after: $cursor, first: $count) {\n    edges {\n      node {\n        id\n        ...followedFragment\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n  id\n}\n"
  }
};
})();

(node as any).hash = "72abd9b6f5853b5b63c6f82a17588987";
