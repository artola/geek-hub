...
export type followingFragment$data = {
  readonly following: {
...
export type followingFragment$key = {
  readonly " $data"?: followingFragment$data;
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": require('./followingPaginationQuery.graphql'),
      "identifierInfo": {
        "identifierField": "id",
